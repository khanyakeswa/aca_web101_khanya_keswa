  ...
  $.fn.extend({
    slimScroll: function(options) {
      ...
      this.each(function() {
        ...
        o.width = o.width == '100%' ? me.parent().width() : o.width
        ...
        if (hasHorizontalScrollbar) {
          ...
          // set position
          var xPosCss =
            o.positionX == 'top' ? { top: o.distance } : { bottom: o.distance }
          railX.css(xPosCss)
          barX.css(xPosCss)
          ...
          if (o.railDraggable) {
            ...
            railX.on('mousedown', function(e) {
              var deltaX =
                ((e.offsetX - barWidth / 2) * me[0].scrollWidth) /
                me.outerWidth()
          ...
          if (o.startX === 'right') {
            ...
            barX.css({ left: (me.outerWidth() - barX.outerWidth()) * 0.5 })
        ...
        if (hasVerticalScrollbar) {
          ...
          if (o.railDraggable) {
            ...
            railY.on('mousedown', function(e) {
              var deltaY =
                ((e.offsetY - barHeight / 2) * me[0].scrollHeight) /
                me.outerHeight()
          ...
          if (o.startY === 'bottom') {
            ...
            barY.css({ top: (me.outerHeight() - barY.outerHeight()) * 0.5 })
            scrollContent(0, 0, true)
        ...
        me.on('touchmove', function(e) {
          ...
          if (e.originalEvent.touches.length) {
            ...
            var diffX =
              (touchDifX - e.originalEvent.touches[0].pageX) / o.touchScrollStep
            var diffY =
              (touchDifY - e.originalEvent.touches[0].pageY) / o.touchScrollStep
            // scroll content
        ...
        function scrollContent(x, y, isWheel, isJump) {
          ...
          if (hasHorizontalScrollbar) {
            ...
            if (
              o.applyVerticalWheelToHorizontal &&
              o.axis == 'x' &&
              !deltaX &&
              !!y
            ) {
            ...
            if (isWheel) {
              ...
              deltaX =
                parseInt(barX.css('left')) +
                (moveFactor * parseInt(o.wheelStep)) / 100
            ...
            percentScrollX =
              parseInt(barX.css('left')) / (me.outerWidth() - barX.outerWidth())
          ...
          if (hasVerticalScrollbar) {
            ...
            if (isWheel) {
              // move bar with mouse wheel
              deltaY =
                parseInt(barY.css('top')) + (y * parseInt(o.wheelStep)) / 100
            ...
            // calculate actual scroll amount
            percentScrollY =
              parseInt(barY.css('top')) /
              (me.outerHeight() - barY.outerHeight())
...
function checkOrientation() {
  $('.gallery').slimScroll({ destroy: true })
  if (window.innerWidth >= window.innerHeight) {
    $('.gallery').slimScroll({
      height: '100vh',
      width: '100vw',
